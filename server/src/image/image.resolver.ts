...
import { FindManyImageArgs } from "./FindManyImageArgs";
import { FindOneImageArgs } from "./FindOneImageArgs";
...
export class ImageResolver {
  ...
  async images(
    @graphql.Args() args: FindManyImageArgs,
  ...
  async image(
    @graphql.Args() args: FindOneImageArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ): Promise<Image | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
